...
public class TestPerformanceMonitorBeanFactory {
	...
	public void testFindPerformanceMonitorBean() {
		...
		PerformanceMonitorBean foundMonitor = factory.findPerformanceMonitorBean(monitorName);
	...
	public void testFindInvalidPerformanceMonitorBean() {
		...
		// and jam it in.
		Map<String, PerformanceMonitor> invalidMap = new HashMap<String, PerformanceMonitor>();
		invalidMap.put(monitorName, new PerformanceMonitor());
		ReflectionTestUtils.setField(factory, "performanceMonitorMap", invalidMap);
	...
	public void testMonitorWithoutMBeanExporter() {
		...
		PerformanceMonitor createdMonitor = factory.createPerformanceMonitor("testCreateWithoutMBeanExporter");
		assertNotNull(createdMonitor);
	}
