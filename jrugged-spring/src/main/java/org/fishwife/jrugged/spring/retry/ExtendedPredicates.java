...
public final class ExtendedPredicates {
	...
	/***
	 * Create a predicate to see if a given object is an instance of a specific
	 * class, given that all objects passed to this predicate will be a subclass of
	 * some parent of that class.
	 *
	 * @param superclazz The class which all objects passed to this predicate will
	 *                   be a subclass of
	 * @param clazz      The class to see if the passed in object will be an
	 *                   instanceof
	...
	/***
	 * Create a predicate to check if a throwable's error message contains a
	 * specific string.
	 *
