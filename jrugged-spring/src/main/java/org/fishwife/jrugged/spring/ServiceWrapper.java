...
public interface ServiceWrapper extends org.fishwife.jrugged.ServiceWrapper {
     ...
     *  @return {@link ListenableFuture} of whatever <code>callable</code> would normally return
     *  @throws Exception because it's part of the {@link Callable#call()} method signature. Exceptions must be handled in the callback methods.
     */
