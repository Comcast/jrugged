...
public class SingleServiceWrapperInterceptor implements MethodInterceptor {
	...
	/**
	 * Checks if the method being invoked should be wrapped by a service. It looks
	 * the method name up in the methodList. If its in the list, then the method
	 * should be wrapped. If the list is null, then all methods are wrapped.
	 *
