...
/**
 * The {@link PerformanceMonitorBean} is a straightforward wrapper around a
 * {@link PerformanceMonitor} that allows for leveraging automated exposure of
 * the information via Spring's JMX annotations.
 */
@ManagedResource
