 ...
 * them. If a {@link MBeanExportOperations} is set, then the CircuitBreakerBean
 * will be automatically exported as a JMX MBean.
 */
public class CircuitBreakerBeanFactory extends CircuitBreakerFactory implements InitializingBean {
	 ...
	 * {@link CircuitBreakerBean} instances as JMX MBeans.
	 * 
	...
	/**
	 * If specified, CircuitBreakerBeanFactory will scan all classes under
	 * packageScanBase for methods with the
	 * {@link org.fishwife.jrugged.aspects.CircuitBreaker} annotation and initialize
	 * circuitbreakers for them.
	 *
	...
	/**
	 * If packageScanBase is defined will search packages for
	 * {@link org.fishwife.jrugged.aspects.CircuitBreaker} annotations and create
	 * circuitbreakers for them.
	 */
	...
	/**
	 * Create a new {@link CircuitBreakerBean} and map it to the provided value. If
	 * the {@link MBeanExportOperations} is set, then the CircuitBreakerBean will be
	 * exported as a JMX MBean. If the CircuitBreaker already exists, then the
