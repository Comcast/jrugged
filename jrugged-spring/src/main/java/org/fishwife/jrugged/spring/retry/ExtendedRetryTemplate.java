...
/***
 * Extended version of the {@link RetryTemplate} to allow easy use of the
 * {@link Callable} interface, instead of the {@link RetryCallback}
 */
public class ExtendedRetryTemplate extends RetryTemplate {
	...
	/***
	 * Construct a {@link Callable} which wraps the given {@link RetryCallback}, and
	 * who's {@link java.util.concurrent.Callable#call()} method will execute the
	 * callback via this {@link ExtendedRetryTemplate}
	 *
	...
	/***
	 * Construct a {@link Callable} which wraps the given {@link Callable}, and
	 * who's {@link java.util.concurrent.Callable#call()} method will execute the
	 * callable via this {@link ExtendedRetryTemplate}
	 *
	 ...
	 *
	 * @param callable         The callable to execute
	 * @param recoveryCallback The recovery callback to execute when exceptions
	 *                         occur
	 * @param retryState       The current retryState
	 * @param                  <T> The return type of the callable
	 * @return The result of the callable
