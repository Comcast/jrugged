 ...
 * of the created instances. If the {@link MBeanExportOperations} is set, then
 * the PerformanceMonitorBean will be automatically exported as a JMX MBean.
 */
public class PerformanceMonitorBeanFactory extends PerformanceMonitorFactory implements InitializingBean {
	 ...
	 * 
	 * @param initialPerformanceMonitors the list of {@link PerformanceMonitorBean}
	 *                                   names
	 */
	...
	/**
	 * If specified, PerformanceMonitorBeanFactory will scan all classes under
	 * packageScanBase for methods with the
	 * {@link org.fishwife.jrugged.aspects.PerformanceMonitor} annotation and
	 * initialize performance monitors for them.
	 *
	...
	public void createInitialPerformanceMonitors() {
		if (packageScanBase != null) {
			...
			for (Method m : methodScanner.findAnnotatedMethods(packageScanBase,
					org.fishwife.jrugged.aspects.PerformanceMonitor.class)) {
				org.fishwife.jrugged.aspects.PerformanceMonitor performanceMonitorAnnotation = m
						.getAnnotation(org.fishwife.jrugged.aspects.PerformanceMonitor.class);
	...
	/**
	 * Set the {@link MBeanExporter} to use to export {@link PerformanceMonitorBean}
	...
	/**
	 * Create a new {@link PerformanceMonitorBean} and map it to the provided name.
	 * If the {@link MBeanExportOperations} is set, then the PerformanceMonitorBean
	 * will be exported as a JMX MBean. If the PerformanceMonitor already exists,
	 ...
	 * 
	 * @param name the value for the {@link PerformanceMonitorBean}
	 * @return the found {@link PerformanceMonitorBean}, or null if it is not found.
	 */
