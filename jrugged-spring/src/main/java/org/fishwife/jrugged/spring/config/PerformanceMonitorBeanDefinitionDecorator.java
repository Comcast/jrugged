 ...
 * that gets associated with the SingleServiceWrapperInterceptor created by the
 * jrugged:methods attribute.
 */
public class PerformanceMonitorBeanDefinitionDecorator implements BeanDefinitionDecorator {
	 ...
	 * monitored. The proxy is associated with the PerformanceMonitorInterceptor for
	 * the bean, which is created when parsing the methods attribute from the
