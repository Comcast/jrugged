...
public @interface Retryable {
	 ...
	 * will retry on. An empty list indicates that the method call will be retried
	 * on ANY Throwable.
	 * 
	...
	/**
	 * Whether the delay should be doubled between tries. The delay will reset to
	 * the original 'retryDelayMillis' values after a successful call or after
	 * 'maxTries' is reached.
	 * 
