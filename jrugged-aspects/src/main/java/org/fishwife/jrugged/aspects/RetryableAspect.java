...
/**
 * Surrounds methods decorated with the
 * {@link org.fishwife.jrugged.aspects.Retryable} annotation with logic to retry
 * the method call.
 */
@Aspect
public class RetryableAspect {
	 ...
	 * @throws Throwable if the method invocation itself throws one during
	 *                   execution.
