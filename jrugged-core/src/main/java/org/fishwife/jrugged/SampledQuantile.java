...
public class SampledQuantile {
	...
	/**
	 * Creates a <code>SampleQuantile</code> that keeps a default number of samples
	 * across its lifetime.
	 */
	...
	/**
	 * Creates a <code>SampleQuantile</code> that keeps a given maximum number of
	 ...
	 * @param units        indication of what time units windowLength is specified
	 *                     in
	 */
	 ...
	 *
	 * @param maxSamples   the maximum number of samples to keep inside of
	 *                     windowLength
	 * @param windowLength size of time window to hold onto samples
	 * @param units        indication of what time units windowLength is specified
	 *                     in
	...
	/**
	 * Returns the <code>k</code>th <code>q</code>-quantile of the samples seen thus
	 * far.
	 *
	 * @param q must be &gt;= 2
	...
	private synchronized void updateWindowSegments(long now) {
		...
		long mostRecentSegmentTimestamp = (windowSegments.size() > 0) ? windowSegments.getLast().timestamp : 0L;
