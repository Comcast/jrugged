...
public class FlowMeter {
	 ...
	 * 
	 * @param counter the {@link RequestCounter} to calculate request rates from
	 */
	 ...
	 *         successful requests per second, failed requests per second. If this
	 *         is the first sample, all three rates will be reported as zero
	 *         requests per second.
	 */
