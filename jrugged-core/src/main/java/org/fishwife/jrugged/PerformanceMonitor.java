...
public class PerformanceMonitor implements ServiceWrapper {
	...
	/**
	 * Returns the average latency in milliseconds of a failed request, as measured
	...
	/**
	 * Returns the average request rate in requests per second of failed requests,
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	...
	/**
	 * Returns the 99th-percentile latency seen by this {@link PerformanceMonitor}
	 * for successful requests.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for successful requests over the last minute.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for successful requests over the last hour.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for successful requests over the last day.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for failed requests over the last minute.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for failed requests over the last hour.
	 * 
	 * @return latency in milliseconds
	 */
	...
	/**
	 * Returns the 95th-percentile latency seen by this {@link PerformanceMonitor}
	 * for failed requests over the last day.
	 * 
	 * @return latency in milliseconds
	 */
