...
/**
 * This is a decorator for an {@link org.apache.http.client.HttpClient} that
 * will raise runtime exceptions for 4XX or 5XX responses, so that they can be
 * used to signal failures to JRugged
